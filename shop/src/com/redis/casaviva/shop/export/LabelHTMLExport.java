...
public class LabelHTMLExport {
	...
	public static File export297x210Labels(String path, Collection<Product.SpecialLabel> labels){
		
		File file = new File(path);
		
		String html = get297x210Label(labels);
	...
	private static String get297x210Label(Collection<Product.SpecialLabel> labels){		
		String html = "<html>";
	...
	private static String get297x210Head(){
		String head = "<head>";
	 ...
	 * @return 
	 */
	private static String get297x210Div(Product.SpecialLabel label){
		String htmlDiv = HTML_LABEL_A4;		
