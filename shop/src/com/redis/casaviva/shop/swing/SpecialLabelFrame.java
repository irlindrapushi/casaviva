...
public class SpecialLabelFrame extends javax.swing.JInternalFrame {
	...
	@SuppressWarnings("unchecked")
     ...
     private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          File file = LabelHTMLExport.export297x210Labels("label_export.html", tableModel.getLabels());
		try {
     ...
     private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
		...
		this.tableModel.getLabels().forEach(l -> {
			if(l.isSelected()) {
				Label label = new Label(l.getCode(), l.getBarcode(), l.getSector(), l.getCateogory(), l.getDescription(), l.getOldPrice(), l.getDiffPriceRatio(), l.getInstant());
				labels.add(label);
			}
		});
		...
		File file = Label.generatePDF(labels);
